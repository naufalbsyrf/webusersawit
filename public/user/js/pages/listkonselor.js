    ...
    querySnapshot.forEach((doc) => {
      ...
      kanbanList.innerHTML = `
        <div class="kanban-header">
          <h5><span id="titlelaporan">${laporanData.name || ""}</span></h5>
        </div>
        <div class="kanban-wrap">
          <div class="panel">
            <div class="kanban-box item-box">
              <div class="img-artikel">
                <a href="konsultasi.html?id=${doc.id}">
                  <img src="${
                    laporanData.img || "./images/profiledefault.png"
                  }" alt="" id="imgLaporan" />
                </a>
              </div>
              <div class="content-box">
              <a href="konsultasi.html?id=${doc.id}">
                <button id="startKonsultasi" class="bton">Konsultasi</button>
              </a>
              </div>
            </div>
          </div>
