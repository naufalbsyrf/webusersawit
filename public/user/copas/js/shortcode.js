    ...
    $('textarea[name="message"]').each(function () {
      ...
      $(".btn-send button").on("click", function (e) {
        if (text.val() == "") {
          ...
          $(
            '<div class="clearfix"></div><div class="message-in"><div class="message-pic"><img src="./images/avatar/message-1.png" alt=""><div class="pulse-css-1"></div></div><div class="message-body"><div class="message-text"><p>' +
              text.val() +
              '</p></div><div class="message-meta"><p>Sunday, march 17, 2021 at 2:59 PM</p></div></div></div>'
          ).appendTo("div.message-box");
          text.val("");
